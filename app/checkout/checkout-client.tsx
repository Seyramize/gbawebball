...
export default function CheckoutClient() {
  ...
  // Update Paystack config when relevant values change
  useEffect(() => {
  ...
  }, [email, name, phone, totalAmount, paymentMethod, product, discountCode, discountAmount, reference])
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container px-4 mx-auto">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center">
            {email && name && phone && street && city && state && postalCode && country && paystackConfig ? (
              <PaystackButton
                {...paystackConfig}
