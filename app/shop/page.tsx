  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen">
        {/* Header */}
        <section className="relative w-full py-12 sm:py-16 md:py-20 bg-amber-950 text-white overflow-hidden">
          ...
          <div className="container relative z-10 px-4 mx-auto text-center">
            <h1 className="mb-4 text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight">
        ...
        <section className="py-8 sm:py-12 md:py-16 bg-white">
          <div className="container px-2 xs:px-4 mx-auto">
            <h2 className="mb-8 sm:mb-10 md:mb-12 text-2xl xs:text-3xl sm:text-4xl font-bold tracking-tight text-center text-gray-900">Shop Categories</h2>

            <div className="grid gap-6 sm:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
              {/* Apparel */}
              <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 hover:shadow-md transition-shadow flex flex-col">
                ...
                <div className="p-4 sm:p-6 flex-1 flex flex-col">
                  <h3 className="mb-3 sm:mb-4 text-lg sm:text-xl font-bold text-amber-900">1. Apparel</h3>
                  <ul className="mb-4 sm:mb-6 space-y-2 text-gray-700 text-sm sm:text-base">
                  ...
                  <Button asChild className="w-full bg-amber-500 hover:bg-amber-600 text-amber-950 mt-auto">
              ...
              <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 hover:shadow-md transition-shadow flex flex-col">
                ...
                <div className="p-4 sm:p-6 flex-1 flex flex-col">
                  <h3 className="mb-3 sm:mb-4 text-lg sm:text-xl font-bold text-amber-900">2. Hunter's Fuel (Juice)</h3>
                  <ul className="mb-4 sm:mb-6 space-y-2 text-gray-700 text-sm sm:text-base">
                    <li className="flex items-center gap-2">
                      <div className="relative h-8 w-8 rounded-full overflow-hidden flex-shrink-0">
                        <Image
              ...
              <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 hover:shadow-md transition-shadow flex flex-col">
                ...
                <div className="p-4 sm:p-6 flex-1 flex flex-col">
                  <h3 className="mb-3 sm:mb-4 text-lg sm:text-xl font-bold text-amber-900">3. Accessories</h3>
                  <ul className="mb-4 sm:mb-6 space-y-2 text-gray-700 text-sm sm:text-base">
                    <li className="flex items-center gap-2">
                      <div className="relative h-8 w-8 rounded-full overflow-hidden flex-shrink-0">
                        <Image
              ...
              <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 hover:shadow-md transition-shadow flex flex-col">
                ...
                <div className="p-4 sm:p-6 flex-1 flex flex-col">
                  <h3 className="mb-3 sm:mb-4 text-lg sm:text-xl font-bold text-amber-900">4. Kingdom of Us Merch</h3>
                  <ul className="mb-4 sm:mb-6 space-y-2 text-gray-700 text-sm sm:text-base">
                    <li className="flex items-center gap-2">
                  ...
                  <div className="bg-amber-100 text-amber-800 px-3 py-2 rounded-md mb-4 text-xs sm:text-sm font-medium text-center">
                    Coming Soon
                  </div>
                  <Button asChild className="w-full bg-amber-500 hover:bg-amber-600 text-amber-950 mt-auto">
        ...
        {/* CTA Section */}
        <section className="py-10 sm:py-14 md:py-16 bg-amber-900 text-white">
          <div className="container px-2 xs:px-4 mx-auto text-center">
            <h2 className="mb-6 sm:mb-8 text-2xl sm:text-3xl md:text-4xl font-bold">Support the Movement. Represent the Mission.</h2>
            <div className="flex flex-col xs:flex-row flex-wrap justify-center gap-3 sm:gap-4">
              <Button asChild size="lg" className="w-full xs:w-auto bg-white hover:bg-gray-100 text-amber-900 font-bold">
                <Link href="/shop">Visit the Full Store</Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="w-full xs:w-auto border-white text-white hover:bg-amber-800">
