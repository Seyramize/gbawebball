...
export function ShopProductCard({ product }: ProductProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 hover:shadow-md transition-shadow p-6">
      {product.featured && <Badge className="mb-2 bg-amber-500 text-amber-950">Featured</Badge>}
